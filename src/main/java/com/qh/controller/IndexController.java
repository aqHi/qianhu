...
import com.qh.service.MessageService;
import com.qh.service.UserService;
import com.qh.util.PictureUtil;
...
public class IndexController {
	...
	public String updateAvatarUrl(MultipartFile paramName, HttpServletRequest request) throws IOException {
		...
		String pic_url = request.getSession().getServletContext().getRealPath("/uploads/avatars/");
		PictureUtil.upload(pic_url , remoteFileName , paramName);
		// 返回图片的URL地址

		String avatarUrl = "/uploads/avatars/" + remoteFileName;
	...
	public @ResponseBody String uploadImage(MultipartFile paramName, HttpServletRequest request) throws IOException {
		...
		String pic_url = request.getSession().getServletContext().getRealPath("/uploads/pic");
		PictureUtil.upload(pic_url , remoteFileName , paramName);

		String picUrl = "/uploads/pic/" + remoteFileName;
